...
import { DiscoverOnboardingModal } from "@/components/discover-onboarding-modal";
import {
  loadDiscoverSession,
  saveDiscoverSession,
 ...
 * `--motion-duration-discover-swipe-accept` / `swipe-reject` (900ms) and ≥ accept burst + heart delay.
 */
const DISCOVER2_SWIPE_ACCEPT_COMMIT_MS = 940;
const DISCOVER2_SWIPE_REJECT_COMMIT_MS = 940;
              ...
              <div ref={menuRef} className="relative">
                ...
                >
                  {currentUser?.avatarImageUrl ? (
                    ...
                    <span
                      className={`flex h-6 w-6 items-center justify-center rounded-full text-[11px] font-bold tracking-[0.08em] ${
