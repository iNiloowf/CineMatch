...
export function DiscoverPage2Content({
  ...
  return (
    <div
      className="discover-v2-page-stack discover-page-stack flex h-full min-h-0 flex-col gap-[var(--discover-stack-gap)] overflow-visible"
    ...
    >
      ...
      {!isSearchOpen ? (
        <div className="shrink-0 space-y-2.5 sm:space-y-3.5">
          <div
            className={`discover-v2-hero-slab mx-0.5 flex items-start justify-between gap-2 rounded-[22px] border px-2.5 py-2.5 sm:mx-1 sm:gap-3 sm:px-3.5 sm:py-3 ${
              isDarkMode
