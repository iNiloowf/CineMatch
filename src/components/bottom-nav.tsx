  ...
  return (
    ...
    >
      <div
        ...
        className={`mx-auto flex max-w-md items-center justify-between rounded-[26px] px-2 py-1.5 backdrop-blur-2xl ${
          isDarkMode
        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex min-w-0 flex-1 items-center justify-center rounded-[18px] px-1 py-1.5 transition ${
                active
